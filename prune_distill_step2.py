...
from prune_funcs import calculate_iou, get_pos_init, del_pos_init, prune_sam_step1, prune_sam_step2,prune_sam_step2_global
...
parser.add_argument('--traindata_path', type=str,default = '/home2/chenzigeng/SAM_data')
parser.add_argument('--testdata_path', type=str,default = '/home2/chenzigeng/SAM_data')
